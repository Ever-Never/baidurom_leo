...
.method public enter()V
    ...
    invoke-static {v3}, Landroid/net/wifi/WifiStateMachine;->access$23904(Landroid/net/wifi/WifiStateMachine;)I
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-static {v1, v2}, Landroid/net/wifi/WifiStateMachine;->access$24000(Landroid/net/wifi/WifiStateMachine;Ljava/util/ArrayList;)Z
    ...
    invoke-static {v2}, Landroid/net/wifi/WifiStateMachine;->access$23000(Landroid/net/wifi/WifiStateMachine;)Lcom/android/internal/util/State;
    ...
    invoke-static {v2}, Landroid/net/wifi/WifiStateMachine;->access$23900(Landroid/net/wifi/WifiStateMachine;)I
    ...
    invoke-static {v1, v2}, Landroid/net/wifi/WifiStateMachine;->access$25300(Landroid/net/wifi/WifiStateMachine;Ljava/lang/String;)V
    ...
    #calls: Landroid/net/wifi/WifiStateMachine;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v1, v2}, Landroid/net/wifi/WifiStateMachine;->access$25400(Landroid/net/wifi/WifiStateMachine;Lcom/android/internal/util/IState;)V
    ...
    invoke-static {v1, p1}, Landroid/net/wifi/WifiStateMachine;->access$25500(Landroid/net/wifi/WifiStateMachine;Landroid/os/Message;)V
