.class public Lcom/inveno/flow/download/downloadmanager/http/BinaryHttpResponseHandler;
...
.method static constructor <clinit>()V
    ...
    .line 60
    sput-object v0, Lcom/inveno/flow/download/downloadmanager/http/BinaryHttpResponseHandler;->mAllowedContentTypes:[Ljava/lang/String;
...
.method public constructor <init>([Ljava/lang/String;)V
    ...
    .prologue
    .line 77
    invoke-direct {p0}, Lcom/inveno/flow/download/downloadmanager/http/BinaryHttpResponseHandler;-><init>()V

    .line 78
    sput-object p1, Lcom/inveno/flow/download/downloadmanager/http/BinaryHttpResponseHandler;->mAllowedContentTypes:[Ljava/lang/String;
...
.method protected handleFailureMessage(Ljava/lang/Throwable;[B)V
    ...
    .prologue
    .line 136
    invoke-virtual {p0, p1, p2}, Lcom/inveno/flow/download/downloadmanager/http/BinaryHttpResponseHandler;->onFailure(Ljava/lang/Throwable;[B)V
...
.method protected handleMessage(Landroid/os/Message;)V
    ...
    invoke-virtual {p0, v2, v1}, Lcom/inveno/flow/download/downloadmanager/http/BinaryHttpResponseHandler;->handleSuccessMessage(I[B)V
    ...
    invoke-virtual {p0, v1, v2}, Lcom/inveno/flow/download/downloadmanager/http/BinaryHttpResponseHandler;->handleFailureMessage(Ljava/lang/Throwable;Ljava/lang/String;)V
...
.method protected handleSuccessMessage(I[B)V
    ...
    .prologue
    .line 132
    invoke-virtual {p0, p1, p2}, Lcom/inveno/flow/download/downloadmanager/http/BinaryHttpResponseHandler;->onSuccess(I[B)V
...
.method public onFailure(Ljava/lang/Throwable;[B)V
    ...
    .prologue
    .line 110
    invoke-virtual {p0, p1}, Lcom/inveno/flow/download/downloadmanager/http/BinaryHttpResponseHandler;->onFailure(Ljava/lang/Throwable;)V
...
.method public onSuccess(I[B)V
    ...
    .prologue
    .line 98
    invoke-virtual {p0, p2}, Lcom/inveno/flow/download/downloadmanager/http/BinaryHttpResponseHandler;->onSuccess([B)V
...
.method protected sendFailureMessage(Ljava/lang/Throwable;[B)V
    ...
    invoke-virtual {p0, v2, v0}, Lcom/inveno/flow/download/downloadmanager/http/BinaryHttpResponseHandler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;

    move-result-object v0

    invoke-virtual {p0, v0}, Lcom/inveno/flow/download/downloadmanager/http/BinaryHttpResponseHandler;->sendMessage(Landroid/os/Message;)V
...
.method protected sendResponseMessage(Lorg/apache/http/HttpResponse;)V
    ...
    invoke-virtual {p0, v10, v7}, Lcom/inveno/flow/download/downloadmanager/http/BinaryHttpResponseHandler;->sendFailureMessage(Ljava/lang/Throwable;[B)V
    ...
    sget-object v11, Lcom/inveno/flow/download/downloadmanager/http/BinaryHttpResponseHandler;->mAllowedContentTypes:[Ljava/lang/String;
    ...
    invoke-virtual {p0, v3, v10}, Lcom/inveno/flow/download/downloadmanager/http/BinaryHttpResponseHandler;->sendFailureMessage(Ljava/lang/Throwable;[B)V
    ...
    invoke-virtual {p0, v10, v7}, Lcom/inveno/flow/download/downloadmanager/http/BinaryHttpResponseHandler;->sendSuccessMessage(I[B)V
...
.method protected sendSuccessMessage(I[B)V
    ...
    invoke-virtual {p0, v0, v1}, Lcom/inveno/flow/download/downloadmanager/http/BinaryHttpResponseHandler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
